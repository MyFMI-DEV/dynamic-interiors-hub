...
`;
    ...
    createArticle({
      ...
      meta_description: "Explore Harrogate's unique home design trends, from traditional architecture to modern interiors. Get expert insights on local design styles, sustainability, and luxury elements.",
      keywords: [
